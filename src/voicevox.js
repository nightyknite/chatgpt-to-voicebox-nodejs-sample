...
if (require.main === module) {
  (async() => {
    await this.speak("せっしゃおやかたともうすは、おたちあいのうちにごぞんじのおかたもござりましょうが、おえどをたってにじゅうりかみがた、そうしゅうおだわら、いっしきまちをおすぎなされて、あおものちょうをのぼりへおいでなさるれば、らんかんばしとらやとうえもん、ただいまはていはついたして、えんさいとなのりまする。", 0);
  })();  
}